...
describe 'elite::git' do
  let(:subject) do
    ChefSpec::SoloRunner.new(step_into: %w(elite_git)) do |node|
      ...
      node.override['elite']['sliim']['git']['gitignore'] = %w(foo bar baz)
  ...
  it 'creates template[/home/sliim/.dotfiles/gitignore]' do
    config_file = '/home/sliim/.dotfiles/gitignore'
    matches = [start_with('# Generated by Chef!'),
               /^foo$/,
               /^bar$/,
               /^baz$/]
