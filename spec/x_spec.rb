...
describe 'elite::x' do
  let(:subject) do
    ChefSpec::SoloRunner.new(step_into: %w(elite_x elite_desktop_app),
      ...
      node.override['elite']['sliim']['x']['default_session'] = 'mysess'
  ...
  it 'creates template[/home/sliim/.dotfiles/dmrc]' do
    config_file = '/home/sliim/.dotfiles/dmrc'
    matches = [start_with('# Generated by Chef!'),
               /^\[Desktop\]$/,
               /^Session=mysess$/]
  ...
  it 'creates elite_dotlink[sliim-dmrc]' do
    expect(subject).to create_elite_dotlink('sliim-dmrc')
      .with(owner: 'sliim',
            file: 'dmrc')
  end
