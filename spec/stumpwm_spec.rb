...
describe 'elite::stumpwm' do
  ...
  it 'creates template[/home/sliim/.dotfiles/stumpwm.d/program.lisp]' do
    config_file = '/home/sliim/.dotfiles/stumpwm.d/program.lisp'
    matches = [start_with(';; Generated by Chef!'),
  ...
  it 'creates template[/home/sliim/.dotfiles/stumpwm.d/session.lisp]' do
    config_file = '/home/sliim/.dotfiles/stumpwm.d/session.lisp'
    matches = [start_with(';; Generated by Chef!'),
               /"gnew pwnage"$/,
               /"gnew codz"$/,
               /^\(defcommand pwnage/,
  ...
  it 'creates template[/home/sliim/.dotfiles/stumpwm.d/command.lisp]' do
    config_file = '/home/sliim/.dotfiles/stumpwm.d/command.lisp'
    matches = [start_with(';; Generated by Chef!'),
               /^\(defcommand mycmd$/,
